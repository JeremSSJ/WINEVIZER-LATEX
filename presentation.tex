...
% ============================================================
\begin{frame}[t]{Partie 2 -- Value Proposition Canvas : Profil client}
  \transfade
...
% ============================================================
\begin{frame}[t]{Partie 2 -- Value Proposition Canvas : Fit et Misfit}
  \transfade
  \begin{columns}[T]
...
% ============================================================
\begin{frame}[t]{Partie 2 -- Chaîne de valeur : Parcours classique}
  \transfade
...
% ============================================================
\begin{frame}[t]{Partie 2 -- Chaîne de valeur : Parcours alternatif}
  \transfade
...
% ============================================================
\begin{frame}[t]{Partie 3 -- Recommandations : Landing page (R1--R6)}
  \transfade
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \uncover<1->{
      \begin{block}{R1 -- Discours centré sur le ROI}
      ...
      \end{block}
      \vfill
      \begin{block}{R2 -- Preuve sociale crédible}
        \small Témoignages nominatifs avec logos, remontés en section principale
      \end{block}
      \vfill
      \begin{block}{R3 -- Afficher les intégrations POS}
...
% ============================================================
\begin{frame}[t]{Partie 3 -- Recommandations : Onboarding (R7--R12)}
  \transfade
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \uncover<1->{
      \begin{block}{R7 -- Alléger le formulaire d'inscription}
        \small Supprimer Prénom/Nom ; afficher/masquer le MDP ; règles avant la saisie
      \end{block}
      \vfill
      \begin{block}{R8 -- Magic link / OTP sans mot de passe}
    ...
    \begin{column}{0.5\textwidth}
      \uncover<2->{
      \begin{block}{R10 -- Alléger la création d'établissement}
        \small Réduire à 2 champs essentiels (nom + type) ; le reste en optionnel
      \end{block}
      \vfill
      \begin{block}{R11 -- Lever le paywall sur l'import PDF}
        \small Accessible dès la période d'essai ; le fondateur envisage déjà cette décision
      \end{block}
      \vfill
      \begin{block}{R12 -- Rationaliser / unifier les parcours}
