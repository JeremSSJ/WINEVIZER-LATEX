...
% ============================================================
% SLIDE 2 — PARTIE 1 : WINEVIZER EN BREF
% ============================================================
\begin{frame}{Partie 1 -- Winevizer en bref}
  \transfade
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \uncover<1->{
      \begin{block}{Profil entrepreneurial}
        \small
        \begin{itemize}
          \item Sébastien Demoustiez, développeur, Mons
          \item 2 personnes, activité complémentaire
          \item Passage en société prévu T1 2026
          \item CA $\sim$12\,000\,€/an ; charges limitées à l'IT
          \item SEO top 3 sur les requêtes stratégiques
        \end{itemize}
      \end{block}
      }
    \end{column}
    \begin{column}{0.5\textwidth}
      ...
      \begin{block}{Proposition de valeur}
        \small
        \begin{itemize}
          \item Sommelier virtuel contextualisé au stock
          \item Carte digitale synchronisée, exportable PDF
          \item Tableau de bord statistique
          \item Import CSV, manuel ou PDF/photo (IA)
          \item Intégration optionnelle POS
        \end{itemize}
      \end{block}
      }
    \end{column}
...
% ============================================================
% SLIDE 3 — PARTIE 2 : VPC — PROFIL CLIENT
% ============================================================
...
% ============================================================
% SLIDE 7 — PARTIE 3 : RECOMMANDATIONS — LANDING PAGE & ONBOARDING
% ============================================================
\begin{frame}{Partie 3 -- Recommandations : Landing page \& Onboarding}
  \transfade
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \uncover<1->{
      \begin{block}{Landing page (R1--R6)}
        \small
        \begin{itemize}
          \item \textbf{R1} Discours centré sur le ROI dès la page d'accueil
          \item \textbf{R2} Témoignages nominatifs avec logos
          \item \textbf{R3} Afficher les intégrations POS
          \item \textbf{R4} Corriger les défauts visuels
          \item \textbf{R5} Supprimer les sous-pages redondantes
          \item \textbf{R6} Simplifier et valoriser les tarifs
        \end{itemize}
      \end{block}
      }
    \end{column}
    \begin{column}{0.5\textwidth}
      \uncover<2->{
      \begin{block}{Onboarding (R7--R12)}
        \small
        \begin{itemize}
          \item \textbf{R7} Alléger le formulaire d'inscription
          \item \textbf{R8} Magic link / OTP sans mot de passe
          \item \textbf{R9} Persistance de session (cookie sécurisé)
          \item \textbf{R10} Réduire la création d'établissement à 2 champs
          \item \textbf{R11} \textbf{Lever le paywall sur l'import PDF}
          \item \textbf{R12} Rationaliser / unifier les parcours
        \end{itemize}
      \end{block}
      }
    \end{column}
...
% ============================================================
% SLIDE 8 — PARTIE 3 : RECOMMANDATIONS TECHNIQUE & CONCLUSION
% ============================================================
